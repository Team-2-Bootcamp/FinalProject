...
contract AuANFT is IERC721Metadata, ERC721, ERC721URIStorage {
    ...
    constructor() ERC721("Encode SVG BTC Price", "BTCNFT") {
        chain[0] = ChainStruct ({
    ...
    function mint(address to) public returns (uint256) {
        uint256 tokenId = mintFrom(to, 0);
        return tokenId;
    }


    function mintFrom(address to, uint256 sourceId) public returns (uint256) {
